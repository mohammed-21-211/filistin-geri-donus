/**
 * Hafif, tutarlı SVG ikon seti (24×24, çizgi tabanlı).
 * Emoji yerine kurumsal ve profesyonel bir görünüm sağlar.
 */
...
const PATHS = {
  ...
  verify: (
    <>
      <path d="M12 2l2.4 1.9 3 .1 1 2.9 2.4 1.8-1 2.9 1 2.9-2.4 1.8-1 2.9-3 .1L12 22l-2.4-1.9-3-.1-1-2.9L3.2 15.4l1-2.9-1-2.9 2.4-1.8 1-2.9 3-.1z" />
      <path d="M9 12l2 2 4-4" />
    </>
  ),
  mail: (
